...
export default function ShaderBackground({ height = "500px", opacity = 1 }) {
  ...
  return <canvas ref={ref} style={{ position:'absolute', top:0, left:0, width:'100%', height, opacity, pointerEvents:'none', zIndex:0 }} />;
}
